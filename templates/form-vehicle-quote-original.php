...
/* Original 5-step vehicle quote form (v1.12.1), kept so the team can switch
   back: put [cftg_vehicle_quote_original] on the page instead of
   [cftg_vehicle_quote]. Submits through the same handler as the new form. */
