...
<div class="cftg-wrap" id="<?php echo esc_attr( $uid ); ?>" data-form-type="scrap_metal" data-total="2">
  ...
  <div class="cftg-left">
    ...
    <div class="cftg-badge"><i class="fa-solid fa-coins"></i> Instant Offer</div>
    <h2 class="cftg-title">Earn Money for Your <span class="cftg-accent">Scrap Metal</span></h2>
    <p class="cftg-desc">At CFT Recycling, turning your scrap metal into cash is quick and easy. Drop off your materials and get paid on the spot.</p>
    <div class="cftg-feat-grid">
      <div class="cftg-feat-item"><i class="fa-solid fa-chart-line"></i> Top market prices</div>
      <div class="cftg-feat-item"><i class="fa-solid fa-location-dot"></i> Multiple locations</div>
      <div class="cftg-feat-item"><i class="fa-solid fa-dollar-sign"></i> Cash on the spot</div>
      <div class="cftg-feat-item"><i class="fa-solid fa-recycle"></i> All metals accepted</div>
    </div>
  ...
  <div class="cftg-card">
    <div class="cftg-card-header">
      <div class="cftg-step-info">
        <span class="cftg-step-label">Step 1 of 2</span>
